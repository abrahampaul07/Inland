  ...
  return (
    <div id="home" className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center z-0">
        ...
        <h1 className="text-5xl md:text-[80px] mt-[-5px] md:mt-[5px] lg:mt-[20px] lg:text-[132px] text-center text-icon font-bold" data-aos="fade-left" data-aos-duration="2000">
          DREAM
        </h1>
      </div>
    </div>
